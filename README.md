...
- ⚛️ Frontend development using React in bulding static websites (Gatsby), client-side rendered websites (Create React App) and server-side rendered websites (Next). Also, light experience in using Angular and the .NET stack.
- 🔗 Backend developement using Node, with slight experience in Python and Go.
